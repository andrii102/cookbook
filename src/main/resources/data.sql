...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ('Tomato', 100),
              ('Cucumber', 50),
              ('Red Onion', 30),
              ...
              ('Salt', 2),
              ('Black Pepper', 1)
) AS w(ingredient_name, weight) WHERE d.name = 'Greek Salad' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Salt', 3),
              ('Black Pepper', 2)
) AS w(ingredient_name, weight) WHERE d.name = 'Chicken Soup' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Parmesan', 50),
              ('Black Pepper', 3)
) AS w(ingredient_name, weight) WHERE d.name = 'Spaghetti Carbonara' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Olive Oil', 10),
              ('Salt', 3)
) AS w(ingredient_name, weight) WHERE d.name = 'Minestrone Soup' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Olive Oil', 20),
              ('Salt', 2)
) AS w(ingredient_name, weight) WHERE d.name = 'Caesar Salad' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Olive Oil', 10),
              ('Salt', 2)
) AS w(ingredient_name, weight) WHERE d.name = 'Margherita Pizza' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Sugar', 50),
              ('Flour', 30)
) AS w(ingredient_name, weight) WHERE d.name = 'Chocolate Lava Cake' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Basil', 5),
              ('Olive Oil', 10)
) AS w(ingredient_name, weight) WHERE d.name = 'Caprese Salad' AND i.name = w.ingredient_name;
...
SELECT d.id, i.id, w.weight FROM Dish d JOIN Ingredient i ON i.name = w.ingredient_name
    JOIN (VALUES
              ...
              ('Olive Oil', 30),
              ('Salt', 3)
) AS w(ingredient_name, weight) WHERE d.name = 'Garlic Shrimp Pasta' AND i.name = w.ingredient_name;